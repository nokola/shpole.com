  ...
  <div class="max-w-4xl px-4 mx-auto py-4">
    <div class="relative h-10">
      ...
      <div class="absolute right-0 top-1/2 -translate-y-1/2 flex items-center gap-2">
        <!-- Theme Toggle Button -->
        <button
          class="w-8 h-8 rounded-full bg-[hsl(var(--shpole-surface))] border border-[hsl(var(--shpole-border))] flex items-center justify-center cursor-pointer hover:ring-2 hover:ring-[hsl(var(--shpole-primary))] hover:ring-offset-1 hover:ring-offset-[hsl(var(--shpole-bg))]"
